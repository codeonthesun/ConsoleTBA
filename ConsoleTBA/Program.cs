...
";
        ...
        private static void UserChoiceWithHint(string enterPrompt, string gameOver, string journeyPart1, string lineBreaker, ref string guess, string hint, ref int guessAmount, int guessLimit, ref bool outOfGuesses)
        {
